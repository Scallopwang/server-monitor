...
public class Agent implements org.apache.thrift.TBase<Agent, Agent._Fields>, java.io.Serializable, Cloneable, Comparable<Agent> {
  ...
  public Agent setIp(@org.apache.thrift.annotation.Nullable java.lang.String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CPU_FREE:
      if (value == null) {
        ...
        setCpu_free((java.lang.Double)value);
      }
      break;
    ...
    case MEMORY_FREE:
      if (value == null) {
        ...
        setMemory_free((java.lang.Double)value);
      }
      break;
    ...
    case DISK_FREE:
      if (value == null) {
        ...
        setDisk_free((java.lang.Double)value);
      }
      break;
    ...
    case CPU_TOTAL:
      if (value == null) {
        ...
        setCpu_total((java.lang.Double)value);
      }
      break;
    ...
    case MEMORY_TOTAL:
      if (value == null) {
        ...
        setMemory_total((java.lang.Double)value);
      }
      break;
    ...
    case DISK_TOTAL:
      if (value == null) {
        ...
        setDisk_total((java.lang.Double)value);
      }
      break;
    ...
    case TIME_STAMP:
      if (value == null) {
        ...
        setTime_stamp((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(Agent other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCpu_free(), other.isSetCpu_free());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCpu_free()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMemory_free(), other.isSetMemory_free());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemory_free()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDisk_free(), other.isSetDisk_free());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDisk_free()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCpu_total(), other.isSetCpu_total());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCpu_total()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMemory_total(), other.isSetMemory_total());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemory_total()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDisk_total(), other.isSetDisk_total());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDisk_total()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Agent(");
    boolean first = true;
